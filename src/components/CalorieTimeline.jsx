  ...
  return (
    ...
    >
      <div ref={fromTop} className="absolute top-0 px-auto flex flex-col items-center justify-center w-full md:w-[96vw] overflow-hidden py-6 md:py-8">
        ...
        <span className="text-lg md:text-2xl drop-shadow-[0_1px_0px_rgba(0,0,0,0.5)] text-ktheme-500 dark:text-ktheme-300">
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {timelineData.map((item, index) => (
          <div
            key={index}
            className="flex justify-start pt-10 md:pt-40 md:gap-3 lg:gap-10"
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs xl:max-w-sm lg:w-full">
              ...
              <h3 className="hidden md:block text-2xl md:pl-20 md:text-4xl lg:text-5xl font-bold drop-shadow-[0_1px_0px_rgba(0,0,0,0.5)] text-ktheme-500 dark:text-neutral-300 ">
                {item.title}
              </h3>
            </div>
