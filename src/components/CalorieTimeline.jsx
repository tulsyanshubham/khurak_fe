  ...
  return (
    ...
    >
      <div ref={fromTop} className="absolute top-0 px-auto flex flex-col items-center justify-center w-full md:w-[96vw] overflow-hidden py-6 md:py-8">
        ...
        <span className="text-lg md:text-2xl text-ktheme-500 dark:text-ktheme-300">
        ...
        {timelineData.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs xl:max-w-sm lg:w-full">
              ...
              <h3 className="hidden md:block text-2xl md:pl-20 md:text-4xl lg:text-5xl font-bold text-ktheme-500 dark:text-neutral-300 ">
                {item.title}
              </h3>
            </div>
