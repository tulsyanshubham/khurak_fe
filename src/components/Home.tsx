        ...
        <div className='flex flex-col items-center justify-center flex-wrap relative pt-32 overflow-hidden w-full antialiased'>
            <div className='flex flex-wrap justify-evenly items-center w-full mb-10'>
                <div className="flex flex-col justify-center items-center text-center z-10 px-1 md:px-0">
                    <h1 className="text-4xl lg:text-6xl md:text-5xl font-bold text-green-700">Welcome to Khurak</h1>
                    <h2 className="text-2xl lg:text-4xl md:text-3xl font-semibold mt-2">Your Hub for Healthy Eating</h2>
                    <h2 className="text-2xl lg:text-4xl md:text-3xl font-semibold">With Fresh Meals.</h2>
