  ...
  return (
    ...
    >
      <div className='relative w-full z-[0]'>
        <div
          className='flex w-full overflow-x-scroll overscroll-x-auto sm:pt-5 pt-5 pb-8 md:py-30 scroll-smooth [scrollbar-width:none]'
          ref={carouselRef}
  ...
  return (
    <>
        ...
        {open && (
          <div className='fixed inset-0 h-screen z-50 overflow-auto'>
            ...
            >
              ...
              >
                <span
                  dangerouslySetInnerHTML={{ __html: card.content.title }}
                />
              </motion.p>
              <div className='py-10'>
      ...
      >
        ...
        <DirectionAwareHover
          imageUrl={card.src}
          className='h-full inset-x-0 hidden lg:block absolute top-0'
        >
