...
export const DirectionAwareHover = ({
  ...
  return (
    (<motion.div
      ...
      ref={ref}
      className={cn(
        "md:h-[18rem] w-60 h-60 md:w-60 bg-transparent rounded-lg overflow-hidden group/card relative",
        className
      )}>
      <AnimatePresence mode="wait">
        <motion.div
          ...
          <motion.div
            ...
            className={cn("text-white absolute top-0 left-0 z-40", childrenClassName)}>
            {children}
          </motion.div>
        </motion.div>
      </AnimatePresence>
