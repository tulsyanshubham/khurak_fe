...
export default function Home() {
  ...
  return (
    <div className='flex items-center justify-center relative z-0'>
      <div className='flex flex-col items-center justify-center flex-wrap relative pt-32 md:pt-28 w-full max-w-7xl antialiased z-0'>
        <div className='flex flex-wrap justify-evenly items-center w-full'>
          <div className='flex flex-col justify-center items-center text-center px-1 md:px-0 md:w-1/2 xl:w-fit'>
            <BoxReveal boxColor={"#eec14d"} duration={0.5} flag={false}>
              <h1 className='text-4xl md:text-4xl lg:text-5xl font-bold drop-shadow-[0_1px_0px_rgba(0,0,0,0.5)] text-ktheme-500'>
                Welcome to खुRaak
              </h1>
            </BoxReveal>
            <BoxReveal boxColor={"#eec14d"} duration={0.5}>
              <h2 className='text-2xl md:text-2xl lg:text-3xl font-semibold mt-2'>
                Your Hub for Healthy Eating
              </h2>
            </BoxReveal>
            <BoxReveal boxColor={"#eec14d"} duration={0.5}>
            ...
            <BoxReveal boxColor={"#eec14d"} duration={0.5}>
              <p className='text-bold text-base mt-4 max-w-lg px-1'>
                Easily order wholesome meals tailored to your unique lifestyle,
                featuring fresh, nutritious ingredients that promote well-being,
                and enjoy a healthier, happier you with every delicious bite.
              </p>
            </BoxReveal>
